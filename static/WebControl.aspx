...
<head>
	...
	<link href="//web.wwtassets.org/classicweb/wwt.min.css" rel="stylesheet" />
	<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" />
	<script src="//code.jquery.com/jquery-2.1.4.min.js"></script>
	<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
	<script src="//cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js"></script>
	<script src="//web.wwtassets.org/classicweb/main.js"></script>
	<script src="//web.wwtassets.org/classicweb/controls/util.js"></script>
	<script src="//web.wwtassets.org/classicweb/wwtsdk.min.js"></script>
	<script src="//web.wwtassets.org/classicweb/controls/WebControl.js"></script>
	<script src="//web.wwtassets.org/classicweb/controls/move.js"></script>
	<script src="//web.wwtassets.org/classicweb/controls/TourPlayer.js"></script>
	<script>
		var ctl;
		$(window).on('load', function () {
			...
			try {
				options = JSON.parse(decodeURIComponent(location.hash.replace(/#/, '')));
			} catch {}

			if (options.tour) {
				wwt.TourPlayer.init({
					resLoc: '//cdn.worldwidetelescope.org',
					tour: options.tour,
					remote: options
				});
			} else {
